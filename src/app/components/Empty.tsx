    ...
    <div className="rounded-lg lg:w-[728px] sm:w-[641px] xs:w-[295px] h-[469px] bg-light-grey px-[20px] py-[62.5px]">
      <div className="flex flex-col justify-center items-center gap-[40px]">
        ...
        <Image
          ...
          width={124.77}
          height={80}
          className="sm:flex sm:justify-start sm:items-left lg:hidden sm:hidden"
        />
        <div className="flex flex-col justify-center items-center gap-[24px] ">
          <h3 className="leading-[48px] lg:text-[32px] xs:text-[24px] font-[600] font-IntSans">
            Let’s get you started
          </h3>
          <p className="lg:w-[488px] sm:w-[488px] xs:w-[255px] text-center text-[16px] text-grey-color font-IntSans font-[400] leading-[24px]">
