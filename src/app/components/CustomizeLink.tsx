...
//                   <p id="name" className="text-[18px] text-dark-grey font-IntSans font-[600] leading-[27px]"></p>
                  
//                 </div>
//                 <div className="w-[72px] h-[8px] bg-[#EEEEEE] rounded-full">
//                   <p
//                     id="email"
//                     className="text-[14px] text-grey-color font-IntSans font-[400] leading-[21px]"
//                   ></p>
//                 </div>
//               </div>
            ...
            <div className="w-[285px] h-[611px] bg-white border border-border-color items-center justify-between flex flex-col py-[43.5px] px-[23.5px]">
              <div className="items-center justify-center flex flex-col gap-[20px]">
                ...
                <div className="w-[160px] h-[16px] bg-[#EEEEEE] rounded-full">
                  <p
                    id="name"
                    className="text-[18px] text-dark-grey font-IntSans text-center font-[600] leading-[27px]"
                  >
                ...
                <div className="w-[72px] h-[8px] bg-[#EEEEEE] rounded-full">
                  <p
                    id="email"
                    className="text-[14px] text-grey-color font-IntSans text-center w-[40px] font-[400] leading-[21px]"
                  >
                    {formValues.email}
                  </p>
                </div>
